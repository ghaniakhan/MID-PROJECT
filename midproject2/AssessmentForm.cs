...
namespace midproject3
{
    public partial class AssessmentForm : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string[] dateFormats = { "MM/dd/yyyy", "M-d-yyyy", "M/dd/yyyy", "MM/d/yyyy", "M/d/yyyy" };

            if (DateTime.TryParseExact(textBox2.Text, dateFormats, null, System.Globalization.DateTimeStyles.None, out dateCreated))
            {
